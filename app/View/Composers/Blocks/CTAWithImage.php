...
class CTAWithImage extends Composer
{
    protected static $views = [
        'blocks.cta-with-image',
    ];
    ...
    {
        $label = get_field('cta_with_image_label');
        return $label ? $label : '';
    }

    private function title(): string
    {
        $title = get_field('cta_with_image_title');
        return $title ? $title : '';
    }

    private function description(): string
    {
        $description = get_field('cta_with_image_description');
        return $description ? $description : '';
    }

    private function button(): array | null
    {
        $button = get_field('cta_with_image_button');
        return $button ? $button : null;
    }

    private function buttonBg(): string
    {
        $buttonBg = get_field('cta_with_image_button_background');
        return $buttonBg ? $buttonBg : '';
    }

    private function image(): array | null
    {
        $image = get_field('cta_with_image_image');
    ...
    {
        return get_field('cta_with_image_button_outlined');
    }
