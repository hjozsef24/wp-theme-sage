...
class ServicesPrimary extends Composer
{
    protected static $views = [
        'blocks.services-primary',
    ];
    ...
    {
        $title = get_field('services_primary_title');
        return $title ? $title : "";
    }

    private function description(): string
    {
        $description = get_field('services_primary_description');
        return $description ? $description : "";
    }

    private function services(): array
    {
        $services = get_field('services_primary_services');
