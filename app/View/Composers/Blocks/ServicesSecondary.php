...
class ServicesSecondary extends Composer
{
    protected static $views = [
        'blocks.services-secondary',
    ];
    ...
    {
        $title = get_field('services_secondary_title');
        return $title ? $title : "";
    }

    private function description(): string
    {
        $description = get_field('services_secondary_description');
        return $description ? $description : "";
    }

    private function services(): array
    {
        $services = get_field('services_secondary_services');
